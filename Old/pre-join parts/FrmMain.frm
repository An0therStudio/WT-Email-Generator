...
Private Sub UserForm_Activate()
    ...
    INIPath = "W:\Macros\EmailGenerator\EmailGenerator.ini"
    LoadINIData
End Sub
...
' First paragraph:
    EmailContent = "<html><head><style>body {font-family:tahoma}</style></head><body><p>"
    ...
    EmailContent = EmailContent & "Please review conference details and highlighted sections below to ensure everything is set up correctly. You may then answer the highlighted questions, update and highlight any changes you would like to make and reply directly to this email. If you would like to review the details over the phone please fill out the below “Scheduled Walkthrough Request” template and send it to "
    EmailContent = EmailContent & "<a href=" & WTEmail & ">" & WTEmail & "</a>.<br><br>"
    EmailContent = EmailContent & "<span style='background-color:#66ff33; font-size:20px; font-weight:bold' >Over the phone:</span><br>"
...
' Create the Table
    ...
    EmailTable = EmailTable & "</td></tr><tr><td style='border:1px solid black;width:150px;padding-left:15px;padding-top:5px;padding-bottom:5px;background-color:#d7f1ff'><span style='font-weight:bold;'>Scheduled Date</span></td><td style='border:1px solid black;padding-left:15px;padding-top:5px;padding-bottom:5px;background-color:#d7f1ff'>"
    EmailTable = EmailTable & "</td></tr><tr><td style='border:1px solid black;width:150px;padding-left:15px;padding-top:5px;padding-bottom:5px;background-color:#8ac5ff'><span style='font-weight:bold;'>Scheduled Time*</span></td><td style='border:1px solid black;padding-left:15px;padding-top:5px;padding-bottom:5px;background-color:#8ac5ff'>"
    EmailTable = EmailTable & "</td></tr><tr><td style='width:400px;text-align:center;border:1px solid black;padding:5px;background-color:#fcf010' colspan=2><span style='font-size:85%;font-weight:bold;'>*please be sure to include time zone.</span></td></tr></table><br><br>"
    EmailContent = EmailContent & EmailTable
    EmailContent = EmailContent & "<span style='background-color:#66ff33; font-size:20px; font-weight:bold' >Or</span><br>"
    EmailContent = EmailContent & "<span style='background-color:#66ff33; font-size:20px; font-weight:bold' >Via email:</span><br><br>"
...
' Expected parts Details: (Must be manually filled out.)
...
' Recording and transcription services:
    ...
    EmailContent = EmailContent & Recordings
...
Function GetRecordings()
    ...
    If isRecording <> "ERROR NO MATCH FOUND" Then ' There is recordings
        ...
        End If
    Else
        RetStr = RetStr & ChrW(&H2612) & "<span style='background-color:yellow'>NO Recordings requested</span><br>" & Space(1)
    End If
...
Function GetAnnounceAll()
    ...
    If isAnn <> "ERROR NO MATCH FOUND" Then
        RetStr = ChrW(&H2612) & " Annouce All<br>"
    End If
...
Function GetPartEntry()
    ...
    If TollFreeEPPart <> "ERROR NO MATCH FOUND" Then
        ...
        If Passcode <> "ERROR NO MATCH FOUND" Then  ' EP with passcode
            ...
            RetStr = RetStr & "&nbsp;&nbsp;&nbsp;&nbsp;" & ChrW(&H2612) & " Passcode: " & Passcode & "<br>"
        ...
        Else
            ...
            'RetStr = RetStr & "&nbsp;&nbsp;&nbsp;&nbsp;" & ChrW(&H2610) & " Conference ID Number<br>"
            'RetStr = RetStr & "&nbsp;&nbsp;&nbsp;&nbsp;" & ChrW(&H2610) & " Passcode:<br>"
            'RetStr = RetStr & "&nbsp;&nbsp;&nbsp;&nbsp;" & ChrW(&H2610) & " Other:<br>"
        End If
    Else
        'is an oa
        ...
        If Password <> "NO PASSWORD FOUND" Then
            'RetStr = RetStr & "&nbsp;&nbsp;&nbsp;&nbsp;" & ChrW(&H2610) & " Conference ID Number<br>"
            RetStr = RetStr & "&nbsp;&nbsp;&nbsp;&nbsp;" & ChrW(&H2612) & " Password: " & Password & "<br>"
            'RetStr = RetStr & "&nbsp;&nbsp;&nbsp;&nbsp;" & ChrW(&H2610) & " Other:<br>"
        Else
...
' EP Pass code:
    ...
    If Passcode <> "ERROR NO MATCH FOUND" Then
        RetStr = RetStr & "<li><b>EP Passcode:</b> " & Passcode
    End If
' ITFS Numbers:
